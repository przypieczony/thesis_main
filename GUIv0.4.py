...
#
# Created: Sat Mar 28 14:44:26 2015
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.widget = QtGui.QWidget(self.Inputdata)
        self.widget.setGeometry(QtCore.QRect(260, 410, 221, 62))
        self.widget.setObjectName(_fromUtf8("widget"))
        self.gridLayout_2 = QtGui.QGridLayout(self.widget)
        self.gridLayout_2.setMargin(0)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.senderField = QtGui.QLineEdit(self.widget)
        ...
        self.receiverField = QtGui.QLineEdit(self.widget)
        ...
        self.registerButton.setGeometry(QtCore.QRect(610, 410, 98, 27))
        ...
        self.layoutWidget2 = QtGui.QWidget(self.Register)
        self.layoutWidget2.setGeometry(QtCore.QRect(40, 20, 611, 72))
        self.layoutWidget2.setObjectName(_fromUtf8("layoutWidget2"))
        self.horizontalLayout_3 = QtGui.QHBoxLayout(self.layoutWidget2)
        self.horizontalLayout_3.setMargin(0)
        self.horizontalLayout_3.setObjectName(_fromUtf8("horizontalLayout_3"))
        self.phone = QtGui.QLabel(self.layoutWidget2)
        ...
        self.server = QtGui.QLabel(self.layoutWidget2)
        ...
        self.nextButton.setGeometry(QtCore.QRect(610, 370, 98, 27))
        self.nextButton.setObjectName(_fromUtf8("nextButton"))
        self.previousButton = QtGui.QPushButton(self.Register)
        self.previousButton.setGeometry(QtCore.QRect(610, 330, 98, 27))
        self.previousButton.setObjectName(_fromUtf8("previousButton"))
        self.clearRegisterButton = QtGui.QPushButton(self.Register)
        self.clearRegisterButton.setGeometry(QtCore.QRect(610, 460, 98, 27))
        ...
        self.scenarioView = QtGui.QListView(self.tab)
        self.scenarioView.setGeometry(QtCore.QRect(30, 20, 671, 281))
        self.scenarioView.setObjectName(_fromUtf8("scenarioView"))
        ...
        self.label_10.setGeometry(QtCore.QRect(10, 20, 66, 17))
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.toAddressField = QtGui.QLineEdit(self.frame)
        self.toAddressField.setEnabled(True)
        self.toAddressField.setGeometry(QtCore.QRect(10, 90, 179, 27))
        ...
        self.label_11.setGeometry(QtCore.QRect(10, 70, 66, 17))
        self.label_11.setObjectName(_fromUtf8("label_11"))
        self.chooseTemplateButton = QtGui.QPushButton(self.frame)
        self.chooseTemplateButton.setGeometry(QtCore.QRect(210, 140, 151, 27))
        self.chooseTemplateButton.setObjectName(_fromUtf8("chooseTemplateButton"))
        self.fromAddressField = QtGui.QLineEdit(self.frame)
        self.fromAddressField.setEnabled(True)
        self.fromAddressField.setGeometry(QtCore.QRect(10, 40, 179, 27))
        ...
        self.chooseTemplateField = QtGui.QLineEdit(self.frame)
        self.chooseTemplateField.setEnabled(True)
        self.chooseTemplateField.setGeometry(QtCore.QRect(10, 140, 179, 27))
        self.chooseTemplateField.setStatusTip(_fromUtf8(""))
        self.chooseTemplateField.setInputMask(_fromUtf8(""))
        self.chooseTemplateField.setText(_fromUtf8(""))
        self.chooseTemplateField.setFrame(True)
        self.chooseTemplateField.setPlaceholderText(_fromUtf8(""))
        self.chooseTemplateField.setObjectName(_fromUtf8("chooseTemplateField"))
        self.addCaseButton = QtGui.QPushButton(self.tab)
        self.addCaseButton.setGeometry(QtCore.QRect(450, 390, 98, 27))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.addCaseButton.setText(_translate("MainWindow", "Add", None))
    ...
    def getParameters(self):
        ...
        if self.simulateRadioButton.isChecked():
            ...
            self.destePort = random.randint(1024, 65535)
    ...
    def register(self):
        ...
        {"dest_ip": self.template_vars["dest_ip"], "dest_port": self.template_vars["dest_port"], "source_ip": self.template_vars["source_ip"], "source_port": self.template_vars["source_port"], "path": os.path.join('templates', 'message.txt')},
        {"dest_ip": self.template_vars["dest_ip"], "dest_port": self.template_vars["dest_port"], "source_ip": self.template_vars["source_ip"], "source_port": self.template_vars["source_port"], "path": os.path.join('templates', 'message.txt')}
        ]
        self.loadTemplate()
        self.startScenario()
    ...
    def send(self, sip_req, request):
        """ """
        try:
            sending_sock = self.open_sock(request["source_ip"], request["source_port"])
            sending_sock.sendto(str(sip_req),(request["dest_ip"], request["dest_port"]))
        except Exception, e:
