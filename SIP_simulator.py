...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.proxyOneAddresField.setText(_fromUtf8(""))
        ...
        self.proxyOnePortField.setText(_fromUtf8(""))
        ...
        self.proxyTwoAddresField.setText(_fromUtf8(""))
        ...
        self.proxyTwoPortField.setText(_fromUtf8(""))
        ...
        self.senderField.setText(_fromUtf8(""))
        ...
        self.receiverField.setText(_fromUtf8(""))
        ...
        self.label_18.setGeometry(QtCore.QRect(30, 520, 271, 51))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.frame_2 = QtGui.QFrame(self.Inputdata)
        self.frame_2.setGeometry(QtCore.QRect(710, 130, 181, 101))
        self.frame_2.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_2.setObjectName(_fromUtf8("frame_2"))
        self.widget = QtGui.QWidget(self.frame_2)
        self.widget.setGeometry(QtCore.QRect(20, 20, 154, 61))
        ...
        self.simulateRadioButton = QtGui.QRadioButton(self.widget)
        ...
        self.gridLayout_20.addWidget(self.simulateRadioButton, 0, 0, 1, 1)
        ...
        self.gridLayout_20.addWidget(self.label_24, 1, 0, 1, 1)
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(30, 10, 873, 276))
        self.layoutWidget6.setObjectName(_fromUtf8("layoutWidget6"))
        self.gridLayout_17 = QtGui.QGridLayout(self.layoutWidget6)
        self.gridLayout_17.setMargin(0)
        self.gridLayout_17.setObjectName(_fromUtf8("gridLayout_17"))
        self.label_19 = QtGui.QLabel(self.layoutWidget6)
        font = QtGui.QFont()
        font.setItalic(True)
        self.label_19.setFont(font)
        self.label_19.setObjectName(_fromUtf8("label_19"))
        self.gridLayout_17.addWidget(self.label_19, 0, 0, 1, 1)
        self.scenarioField = QtGui.QTextEdit(self.layoutWidget6)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        ...
        self.splitter_2.setGeometry(QtCore.QRect(10, 330, 411, 251))
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(780, 440, 131, 121))
        ...
        self.layoutWidget8.setGeometry(QtCore.QRect(0, 10, 931, 53))
        self.layoutWidget8.setObjectName(_fromUtf8("layoutWidget8"))
        self.gridLayout_6 = QtGui.QGridLayout(self.layoutWidget8)
        self.gridLayout_6.setMargin(0)
        self.gridLayout_6.setObjectName(_fromUtf8("gridLayout_6"))
        self.proxyTwoHW = QtGui.QLineEdit(self.layoutWidget8)
        ...
        self.sourceHW = QtGui.QLineEdit(self.layoutWidget8)
        ...
        self.destHW = QtGui.QLineEdit(self.layoutWidget8)
        ...
        self.proxyOneHW = QtGui.QLineEdit(self.layoutWidget8)
        ...
        self.layoutWidget9.setGeometry(QtCore.QRect(0, 70, 931, 50))
        ...
        self.phone = QtGui.QLabel(self.layoutWidget9)
        ...
        self.line_2 = QtGui.QFrame(self.layoutWidget9)
        ...
        self.server = QtGui.QLabel(self.layoutWidget9)
        ...
        self.line = QtGui.QFrame(self.layoutWidget9)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.server_2 = QtGui.QLabel(self.layoutWidget9)
        ...
        self.line_3 = QtGui.QFrame(self.layoutWidget9)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.phone_2 = QtGui.QLabel(self.layoutWidget9)
        ...
        self.layoutWidget10 = QtGui.QWidget(self.Simulation)
        self.layoutWidget10.setGeometry(QtCore.QRect(780, 380, 137, 21))
        self.layoutWidget10.setObjectName(_fromUtf8("layoutWidget10"))
        self.gridLayout_8 = QtGui.QGridLayout(self.layoutWidget10)
        self.gridLayout_8.setMargin(0)
        self.gridLayout_8.setObjectName(_fromUtf8("gridLayout_8"))
        self.flowLabel_2 = QtGui.QLabel(self.layoutWidget10)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_59 = QtGui.QLabel(self.layoutWidget10)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.splitter_5.setGeometry(QtCore.QRect(440, 330, 321, 251))
        ...
        self.layoutWidget11 = QtGui.QWidget(self.Simulation)
        self.layoutWidget11.setGeometry(QtCore.QRect(80, 120, 773, 196))
        self.layoutWidget11.setObjectName(_fromUtf8("layoutWidget11"))
        self.gridLayout_16 = QtGui.QGridLayout(self.layoutWidget11)
        self.gridLayout_16.setMargin(0)
        self.gridLayout_16.setObjectName(_fromUtf8("gridLayout_16"))
        self.flowLabel = QtGui.QLabel(self.layoutWidget11)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.flowField = QtGui.QTextEdit(self.layoutWidget11)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.flowField.sizePolicy().hasHeightForWidth())
        self.flowField.setSizePolicy(sizePolicy)
        self.flowField.setMinimumSize(QtCore.QSize(777, 171))
        self.flowField.setMaximumSize(QtCore.QSize(777, 171))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Courier New"))
        font.setPointSize(10)
        font.setBold(False)
    ...
    def retranslateUi(self):
        ...
        self.tabWidget.setToolTip(_translate("MainWindow", "Disable this if you want use real hardware", None))
        ...
        self.label_18.setText(_translate("MainWindow", "If you don\'t need any of the hardware leave blank fields (IP and port!)", None))
        self.simulateRadioButton.setText(_translate("MainWindow", "Simulation", None))
        self.label_24.setText(_translate("MainWindow", "Enable this to fill all fields automatically", None))
    ...
    def getParameters(self):
        """This function captures input parameters and saves it to dictionary"""
        try:
...
If you want exclude some hardware, be sure that both, port and IP, are empty""", "Whopsie..", 'warning')
    ...
    def prepareFieldsToSimulation(self):
        ...
        self.sipTemplate.insertPlainText(self.printParameters())
    ...
    def printParameters(self):
        """Method to generates startup message with current parameters """
